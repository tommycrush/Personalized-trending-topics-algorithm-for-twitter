...
require("timeline_bank.class.php");
...
/*
//Want to building HTML or JSON from the results? [a.k.a. - using this as an ajax file], customize these functions:
$timeline_bank->build_snapshot_and_html();
*/
?>